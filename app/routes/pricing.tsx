        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">Perfect for small stores getting started with bundling</p>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-blue-500 relative">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">Ideal for growing businesses with advanced bundling needs</p>
            </div>
            <ul className="space-y-4 mb-8">
              <li className="flex items-center">
                <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border border-gray-200">
            <div className="text-center">
              ...
              <div className="text-4xl font-bold text-gray-900 mb-4">
                Custom<span className="text-lg font-normal text-gray-600 block">pricing</span>
              </div>
              <p className="text-gray-600 mb-6">For large-scale operations with custom requirements</p>
            </div>
            <ul className="space-y-4 mb-8">
              <li className="flex items-center">
                <svg className="w-5 h-5 text-green-500 mr-3" fill="currentColor" viewBox="0 0 20 20">
